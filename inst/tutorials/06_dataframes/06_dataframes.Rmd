...
- Les objets *data.frame* contenant potentiellement autre chose que des valeurs numérique la fonction *hist()* ne les acceptera pas par défaut. Convertissez le *data.frame* suivant en matrice (objet $mat$) et passez cette matrice à la fonction *hist()* pour construire l'histogramme correspondant.  
