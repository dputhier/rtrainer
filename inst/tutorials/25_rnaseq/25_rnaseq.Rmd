...
Draw the distribution of the log2 fold changes for all genes using the `hist()` function.
Do do so:
...
quiz(
  ...
  question("Why is log2 fold change preferred over log10 fold change in RNA-Seq analysis?",
    answer("Because log2(2) = 1, making it easier to interpret fold changes in terms of doubling or halving of expression levels compare to log10(2) ≈ 0.301.", 
           correct = TRUE),
...
# Somep-values may be undefined (NA)
