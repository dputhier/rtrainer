...
```{r filepath, exercise=TRUE, exercise.setup="dircreate_1" }
...
```{r exo_dir, exercise=TRUE, exercise.setup="filepath" }
...
- Using `dir()` check the content of "rtrainer_projects" and "rtrainer_projects/project_1"

```{r exomkdir, exercise=TRUE, exercise.setup="exo_dir"}
...
```{r setwd, exercise=TRUE, exercise.setup="exomkdir" }
getwd()
fp
setwd(filepath)
getwd()
...
```{r readtable_2, exercise=TRUE, exercise.setup="setwd"}
