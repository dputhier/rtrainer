...
if(file.exists(file.path(fs::path_home(), ".rtrainer", "rGREAT_result.rds")))
  file.remove(file.path(fs::path_home(), ".rtrainer", "rGREAT_result.rds"))

if(file.exists(file.path(fs::path_home(), ".rtrainer", "rGREAT_tbl.rds")))
  file.remove(file.path(fs::path_home(), ".rtrainer", "rGREAT_tbl.rds"))
```
