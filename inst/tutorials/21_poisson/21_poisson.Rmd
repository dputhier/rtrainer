...
gradethis::grade_result_strict(
  gradethis::pass_if(~ abs(prob_3 - dpois(3, lambda = 2)) < 1e-10),
  gradethis::pass_if(~ abs(cum_prob_5 - ppois(5, lambda = 4)) < 1e-10),
  gradethis::pass_if(~ length(random_pois) == 100),
  gradethis::pass_if(~ sum(random_pois) == 501),
  gradethis::pass_if(~ abs(prob_more_4 - (1 - ppois(4, lambda = 3))) < 1e-10),
  gradethis::pass_if(~ abs(prob_4_or_more - ppois(4-1, lambda = 3, lower.tail=FALSE)) < 1e-10)
)
```
:::
