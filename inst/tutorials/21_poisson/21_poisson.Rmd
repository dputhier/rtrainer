...
gradethis::grade_result_strict(
  ...
  gradethis::pass_if(~ identical(prob_5_white, dhyper(5, m, n, k))),
  
  # 2. Probability of at most 5 white balls
  gradethis::pass_if(~ identical(p_at_most_5, phyper(5, m, n, k))),
  
  # 3. Probability of 5 or more white balls
  gradethis::pass_if(~ identical(p_5_or_more, phyper(5-1, m, n, k, lower.tail = FALSE))),
  
  # 4. Empirical simulation
  gradethis::pass_if(~ identical(x_sim, rhyper(10000, m, n, k))),
  
  # 5. Empirical mean
  gradethis::pass_if(~ identical(mean_empirical, mean(x_sim))),
  
  # 6. Theoretical mean
  gradethis::pass_if(~ identical(mean_theoretical, k * m / (m + n)))
)
```
:::
