...
library(png)
pp <- readPNG(RCurl::getURLContent("https://zenodo.org/records/15083675/files/ggbasics.png"))
plot.new() 
...
library(png)
library(RCurl)
pp <- readPNG(RCurl::getURLContent("https://zenodo.org/records/15083675/files/diamonds.png"))
plot.new() 
rasterImage(pp,0,0,1,1)
```
...
library("png")
library(RCurl)
pp <- readPNG(RCurl::getURLContent("https://zenodo.org/records/15083675/files/point.png"))
plot.new() 
rasterImage(pp,0,0,1,1)
```
...
```{r, echo=FALSE, fig.height=5}
library(png)
pp <- readPNG(RCurl::getURLContent("https://zenodo.org/records/15083675/files/ggstar.png"))
plot.new() 
rasterImage(pp,0,0,1,1)
```
