...
library(png)
download.file("https://zenodo.org/records/15083675/files/ggbasics.png", 
              destfile = file.path(fs::path_home(), ".rtrainer", "ggbasics.png"))
pp <- readPNG(file.path(fs::path_home(), ".rtrainer", "ggbasics.png"))
plot.new() 
...
library(png)
download.file("https://zenodo.org/records/15083675/files/diamonds.png", 
              destfile = file.path(fs::path_home(), ".rtrainer", "diamonds.png"))
pp <- readPNG(file.path(fs::path_home(), ".rtrainer", "diamonds.png"))
plot.new() 
rasterImage(pp,0,0,1,1)
...
library(png)
download.file("https://zenodo.org/records/15083675/files/point.png", 
              destfile = file.path(fs::path_home(), ".rtrainer", "point.png"))
pp <- readPNG(file.path(fs::path_home(), ".rtrainer", "point.png"))
plot.new() 
rasterImage(pp,0,0,1,1)
...
library(png)
download.file("https://zenodo.org/records/15083675/files/ggstar.png", 
              destfile = file.path(fs::path_home(), ".rtrainer", "ggstar.png"))
pp <- readPNG(file.path(fs::path_home(), ".rtrainer", "ggstar.png"))
plot.new() 
rasterImage(pp,0,0,1,1)
