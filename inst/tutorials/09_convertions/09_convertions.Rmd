...
learnr::question("Quel est le comportement de R quand on utilise la fonction plot ?",
  ...
  answer("Si le premier argument est un vecteur, R affiche au hasard les valeurs du vecteur."),
  ...
  answer("Si le premier argument est vecteur (et que l'argument y n'est pas renseigné), R affiche en x la position dans le vecteur et en y la valeur correspondante.", correct = TRUE),
